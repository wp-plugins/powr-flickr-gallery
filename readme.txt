...
Sync any Flickr accounts to a custom gallery!

== Description ==
 Sync any Flickr accounts to a custom gallery!
<br>
<br>
POWr Flickr Gallery is a free cloud-based plugin you can edit in your live web page.  Create a POWr account to access the entire <a href='https://www.powr.io/plugins'>plugin library</a>.
<br>
<br>
First, download, install, and activate POWr Flickr Gallery. Then drop the widget anywhere in your theme. Or add to a page/post with the POWr icon in the WP editor.
<br>
= <a href='http://www.powr.io/tutorials/how-to-add-flickr-gallery-plugin-to-your-wordpress-site'>2 MINUTE INSTALL</a> =
<br>
= Free Features =
* Sync images from any public Flickr account.
* Adjust priority for different accounts to fine tune your content.
...
* Display up to 5 different accounts
...
= How do I add Flickr Gallery to a page or blog post? = Add the shortcode **[powr-flickr-gallery label='Enter any label here']** to any page or post. Then visit your live site to edit.

= Can I add more than one Flickr Gallery? = Yes, absolutely!  To clone your Flickr Gallery, just add the exact same shortcode to pages or posts.  To create a new version of Flickr Gallery, add a different shortcode to each page or post, for example: **[powr-flickr-gallery label='first form']**, and **[powr-flickr-gallery label='second form']**.

= Will my users see the settings icon in the corner of the Flickr Gallery? = No! You only see the settings icon because you own the plugins. To temporarily hide it, click on your page and then type 'p + down arrow' (the letter p followed by the down arrow). You can show the icon again by typing 'p + up-arrow'.
...
= Is POWr Flickr Gallery Free? = Yes, the basic version of Flickr Gallery is completely free!
